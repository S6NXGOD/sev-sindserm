      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {podeEditar ? (
            ...
            <>Sua senha e as notificações deste dispositivo.</>
          )}
        </p>
      </div>

      {/* Gestão de logos — só para quem tem Configurações = "Visualizar e editar". */}
      {podeEditar && (
        <>
          <Card>
            <CardHeader>
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  ...
                  <CardDescription>
                    Use o seletor de pleito na barra lateral para configurar
                    outro ano. Enquanto não houver upload, são usadas logos
                    genéricas padrão.
                  </CardDescription>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                nenhum pleito). Use a Galeria de Mídia para escolher uma imagem
                já enviada ou subir uma nova.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <LoginLogoManager
